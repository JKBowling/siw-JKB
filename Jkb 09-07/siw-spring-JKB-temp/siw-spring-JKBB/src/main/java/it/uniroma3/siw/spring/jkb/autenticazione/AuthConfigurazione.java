...
public class AuthConfigurazione extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.antMatchers(HttpMethod.GET,"/","/index", "/admin/**","/torneo/**", "/informazioni","/tournament","/tornei","/admin/nuovoTorneo","/admin/addTorneo","/images/**", "/salePartner").permitAll()
			// chiunque (autenticato o no) può mandare richieste POST al punto di accesso per login e register 
			.antMatchers(HttpMethod.POST, "/login","/admin/**","/admin/nuovoTorneo","/admin/addTorneo", "/register").permitAll()
