package it.uniroma3.siw.spring.jkb.autenticazione;
...
import static it.uniroma3.siw.spring.jkb.model.Credentials.ADMIN_ROLE;
...
public class AuthConfigurazione extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.antMatchers(HttpMethod.GET,"/","/index", "/informazioni", "/images/**", "/salePartner", 
										"/HoF", "/tournament","/tornei","/admin/nuovoTorneo",
										"/admin/addTorneo", "/login", "/register").permitAll()
			// chiunque (autenticato o no) può mandare richieste POST al punto di accesso per login e register 
			.antMatchers(HttpMethod.POST, "/login", "/register", "/admin/**","/admin/nuovoTorneo","/admin/addTorneo").permitAll()
